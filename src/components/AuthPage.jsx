...
// Backend root URL
const API_ROOT = process.env.REACT_APP_API_URL || 'https://digicityoy-223.onrender.com';
...
const AuthPage = () => {
  ...
  const handleAuth = async (e) => {
    ...
    const url = `${API_ROOT}/api/auth`; // backend route
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(
          activeTab === 'login' ? t('auth.loginSuccess') : t('auth.signupSuccess')
        );
